package com.example.ducdung.sms_edit.widget;
...
public class CircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void setup() {
        if (!this.mReady) {
            ...
            this.mDrawableRect.set((float) this.mBorderWidth, (float) this.mBorderWidth,
                    this.mBorderRect.width() - ((float) this.mBorderWidth),
                    this.mBorderRect.height() - ((float) this.mBorderWidth));
